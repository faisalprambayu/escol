...
<body class="">
  ...
  <main id="main" class="main">
    ...
    @include('components.ad_breadcrumb', ['title' => "Friend Management" , 'breadcrumb1' => "Pages", 'breadcrumb2' => "Friend"])
    ...
    <section class="section">
              ...
              <h5 class="card-title">Table with hoverable rows</h5>
                ...
                <table class="table table-hover" id="tableData">
                    ...
                    <tr>
                        ...
                        <td class="space"><img class="d-block w-75" src="{{url('resource/friend/'.$datas['Image'])}}" alt="{{str_replace('public/files/', '', $datas['Image'])}}"></td>
        ...
        <div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="exampleModalLabel">Create Friend</h5>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <form enctype="multipart/form-data" name="add-event" id="add-event" method="post" action="{{url('api/friend')}}" >
                                <div class="row mb-3">
                                   <label for="inputText" class="col-sm-2 col-form-label">Nama Friend</label>
                                    <div class="col-sm-10">
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Friend</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="col-lg-12">
  ...
  <script>
    ...
    tableData.addEventListener('click', function (e) {
        ...
        if (e.target.className == 'dropdown-item edit') {
            ...
            document.querySelector('#edit-event').setAttribute("action", base_url+'/api/friend/update/');
