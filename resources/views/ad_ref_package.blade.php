...
<body>
  ...
  <main id="main" class="main">
    ...
    @include('components.ad_breadcrumb', ['title' => "Package Management" , 'breadcrumb1' => "Master Data", 'breadcrumb2' => "Package"])
  ...
  <script>
    ...
    tableData.addEventListener('click', function (e) {
        if (e.target.className == 'dropdown-item edit') {
            ...
            document.querySelector('#edit-package').setAttribute("action", base_url+'/api/r_package/'+id);
