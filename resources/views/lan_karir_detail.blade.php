...
<body>
    ...
    <main id="main">
        ...
        <div class="breadcrumbs" data-aos="fade-in">
            <div class="container">
                <h2>Detail Karir Esschool.id</h2>
            </div>
        </div>
        <!-- End Breadcrumbs -->
        ...
        <section id="course-details" class="course-details">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-lg-8">
                    <img style="border-radius: 10px;" src="{{url('resource/career/'.$data['career']['Image'])}}" class="img-fluid" alt="">
                    <h3><?= $data['career']['Name'] ?></h3>
                    <p>
                        <?= $data['career']['Text'] ?>
                    </p>
                    </div>
                        ...
                        <div class="sidebar">
                          ...
                          <div class="sidebar-item recent-posts">
                            ...
                            <div class="post-item clearfix">
                              <img src="{{url('resource/career/'.$datas['Image'])}}" alt="">
