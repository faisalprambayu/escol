...
<body class="">
  ...
  <main id="main" class="main">
    ...
    @include('components.ad_breadcrumb', ['title' => "Scholarship Management" , 'breadcrumb1' => "Pages", 'breadcrumb2' => "Scholarship"])
    ...
    <section class="section">
              ...
              <h5 class="card-title">Table with hoverable rows</h5>
                ...
                <table class="table table-hover" id="tableData">
                    ...
                    <tr>
                        ...
                        <td class="space"><img class="d-block w-75" src="{{url('resource/scholarship/'.$datas['Image'])}}" alt="{{str_replace('public/files/', '', $datas['Image'])}}"></td>
        ...
        <div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="exampleModalLabel">Create Scholarship</h5>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <form enctype="multipart/form-data" name="add-event" id="add-event" method="post" action="{{url('api/scholarship')}}" >
                                @csrf
                                <div class="row mb-3">
                                   <label for="inputText" class="col-sm-3 col-form-label">Nama Scholarship</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="row mb-3">
                                    <label for="inputText" class="col-sm-3 col-form-label">Isi</label>
                                    <div class="col-sm-9">
  ...
  <script>
    ...
    tableData.addEventListener('click', function (e) {
        ...
        if (e.target.className == 'dropdown-item edit') {
            ...
            document.querySelector('#edit-event').setAttribute("action", base_url+'/api/scholarship/update');
