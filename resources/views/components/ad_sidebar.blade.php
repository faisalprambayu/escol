...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/package">
          <i class="bi bi-box"></i>
          <span>Package</span>
        </a>
      </li><!-- End Profile Page Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/service">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/video">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/footer">
